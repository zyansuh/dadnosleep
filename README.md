...
| 상황 | 설명 |
|------|------|
| 관리자가 미리 등록 | **대기**가 정상 — Discord **첫 로그인** 후 **완료**로 바뀜 |
| @사용자명 대신 숫자 ID만 입력 | 매칭 실패 — **@사용자명** 또는 **Discord ID** 필드에 snowflake 입력 |
| 로그인했는데도 guest | 등록한 @이름·표시 이름·닉네임이 Discord 프로필과 일치하는지 확인 후 재로그인 |
